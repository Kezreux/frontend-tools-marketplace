...
export const theme: Theme = {
  ...
  colors: {
    ...
    card:                  { light: "0 0% 100%",      dark: "220 12% 11%" },
    cardForeground:        { light: "220 14% 15%",    dark: "220 8% 92%" },
    popover:               { light: "0 0% 100%",      dark: "220 12% 11%" },
    popoverForeground:     { light: "220 14% 15%",    dark: "220 8% 92%" },
