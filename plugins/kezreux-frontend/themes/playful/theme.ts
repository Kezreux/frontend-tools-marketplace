...
export const theme: Theme = {
  ...
  colors: {
    ...
    card:                  { light: "0 0% 100%",      dark: "250 25% 7%" },
    cardForeground:        { light: "250 15% 12%",    dark: "0 0% 95%" },
    popover:               { light: "0 0% 100%",      dark: "250 25% 7%" },
    popoverForeground:     { light: "250 15% 12%",    dark: "0 0% 95%" },
    primary:               { light: "262 83% 58%",    dark: "262 83% 58%" },
    primaryForeground:     { light: "0 0% 100%",      dark: "0 0% 100%" },
    secondary:             { light: "30 100% 60%",    dark: "30 95% 60%" },
    secondaryForeground:   { light: "30 80% 12%",     dark: "30 80% 12%" },
    muted:                 { light: "262 30% 96%",    dark: "250 20% 14%" },
    mutedForeground:       { light: "250 8% 45%",     dark: "250 8% 65%" },
    accent:                { light: "185 84% 49%",    dark: "185 84% 55%" },
    accentForeground:      { light: "185 100% 8%",    dark: "185 100% 8%" },
    border:                { light: "262 20% 90%",    dark: "250 15% 20%" },
    input:                 { light: "262 20% 90%",    dark: "250 15% 20%" },
    ring:                  { light: "262 83% 58%",    dark: "262 83% 65%" },
    destructive:           { light: "340 85% 45%",    dark: "340 85% 47%" },
