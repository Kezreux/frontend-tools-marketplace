...
export const theme: Theme = {
  ...
  colors: {
    ...
    card:                  { light: "38 38% 95%",     dark: "25 18% 10%" },
    cardForeground:        { light: "25 30% 20%",     dark: "38 25% 90%" },
    popover:               { light: "38 38% 95%",     dark: "25 18% 10%" },
    popoverForeground:     { light: "25 30% 20%",     dark: "38 25% 90%" },
